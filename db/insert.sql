...
INSERT INTO public.article (publisher, title, preview, imgURL, linkURL, proposal_id, approved) VALUES ('www.http://videnskab.dk/','Legalisering af hash: Hvad kan vi lære af udlandet?','I Danmark taler vi om at legalisere hash, men debatten er totalt blottet for erfaringer og fakta. Vidste du f.eks., at hash er ulovlig i Holland? Her leverer forskere fra fire lande fakta og fortæller om internationale erfaringer med at håndtere fri hash.','http://videnskab.dk/sites/default/files/styles/columns_12_12_desktop/public/article_media/hashryger_hoejre.jpg?itok=IgyN4EhV&timestamp=1479129383','http://videnskab.dk/kultur-samfund/legalisering-af-hash-hvad-kan-vi-laere-af-udlandet',3, true);
INSERT INTO public.article (publisher, title, preview, imgURL, linkURL, proposal_id, approved) VALUES ('www.dr.dk','Legalisering af cannabis: Politikere og eksperter er rygende uenige','Fra "en ubetinget god idé" til "en forbrydelse mod børn og unge". Meningerne er legalisering af cannabis er mange.','http://asset.dr.dk/imagescaler/?file=/images/crop/2016/06/18/1466268127_scanpix-20160617-161033-l.jpg&server=www.dr.dk&w=620&h=349&scaleAfter=crop&quality=75&ratio=16-9','http://www.dr.dk/nyheder/indland/legalisering-af-cannabis-politikere-og-eksperter-er-rygende-uenige',3, true);
INSERT INTO public.article (publisher, title, preview, imgURL, linkURL, proposal_id, approved) VALUES ('www.dr.dk','OVERBLIK Det mener partierne om legalisering af hash','Langt fra Borgen besøger i aften Christiania for at tale om løsninger på hashmarkedets problemer','http://asset.dr.dk/imagescaler/?file=/images/other/2016/10/20/scanpix-20160906-200446-4.jpg&server=www.dr.dk&w=620&h=349&scaleAfter=crop&quality=75&ratio=16-9','http://www.dr.dk/nyheder/indland/overblik-det-mener-partierne-om-legalisering-af-hash',3, true);
INSERT INTO public.article (publisher, title, preview, imgURL, linkURL, proposal_id, approved) VALUES ('www.stofbladet.dk','Konsekvenser i et socialt perspektiv
ved brug af hash og alkohol ','Center for Rusmiddelforskning har i en stor ny undersøgelse set på unge, der misbruger rusmidler','http://www.stofbladet.dk/6storage/586/35/stof-logo-med-txt-2.jpg','http://www.stofbladet.dk/6storage/586/51/stof21.10-15.pdf',3, true);
