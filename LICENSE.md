This software and associated documentation files (the "Software") are licensed under the Creative Commence Attribution-NonCommercial 3.0 Unported (CC BY-NC 3.0).
