      ...
      return (
        <div className="mw8 center tc">
          ...
          <div className="mw6 center bg-white mv2 pa4 ba b--black-10 br1 shadow-6">
            ...
            <a onClick={() => this.handleVote(false)} className="pointer dib white bg-dark-blue hover-bg-blue w4 pv2 ma3 ba b--black-10 br1 shadow-6">Imod</a>
          ...
          <div id="modal" className="modal dn items-center justify-center overflow-auto w-100 h-100 pa2 z-5">
            {this.state.error ?
            <div className="pv3 ph5 tc bg-white ba b--black-10 br1">
            ...
            <div className="pv3 ph5 tc bg-white ba b--black-10 br1">
              ...
              <a onClick={this.closeModal} className="pointer dib dark-blue w4 pv2 ma3 ba b--dark-blue br1">Annuller</a>
              <a onClick={this.handleSubmit} className="pointer dib white bg-dark-blue hover-bg-blue w4 pv2 ma3 ba b--black-10 br1 shadow-6">Bekræft</a>
            </div>}
          </div>
        </div>
      );
