      ...
      <div>
            ...
            return (
              <li key={index}>
                ...
                <a
                  ...
                  target="_newtab"
                  className="db near-black ba b--light-gray br2 mv3 h10 overflow-hidden card"
                >
                  ...
                  <div className="dib w-70 v-top pv1 ph3">
                    <h3>{title}</h3>
                    <small className="f5 small-caps ttl silver">{publisher}</small>
        ...
        <div id="submitmodal" className="modal">
          <div className="modal-content">
            ...
            <br />
            <p>
              En af vores redaktører laver review på artiklen og uploader den til lovforslaget inden længe.<br />
              <br />
              <br />
