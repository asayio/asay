    ...
    return(
      <div className="mw8 center w-100 flex-auto">
        ...
        <div className="tc mt3">
          <Link to="/" className="db dib-ns b white bg-dark-blue hover-bg-blue pv2 ph4 ba b--black-10 br1 shadow-6"><ArrowRight className="mr2"/>Videre til lovforslagene</Link>
        </div>
      </div>
    );
  }
