...
class Vote extends Component {
  ...
  render() {
    ...
    const modalHeader = this.state.error
      ? 'Der er sket en fejl'
      : this.state.voteConfirmed ? 'Din valghandling er registreret' : 'Er du sikker?';
    ...
    return (
      <div className="mw8 center w-100 flex-auto tc">
        ...
        <div id="modal" className="items-center justify-center overflow-auto w-100 h-100 pa2 z-9999 dn">
